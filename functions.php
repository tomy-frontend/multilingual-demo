...
function my_script_init()
{
    ...
    wp_enqueue_script("my-script-module", get_template_directory_uri() . "/js/script.js", array(), filemtime(get_theme_file_path("/js/script.js")), true);
    wp_script_add_data("my-script-module", "type", "module");
}
